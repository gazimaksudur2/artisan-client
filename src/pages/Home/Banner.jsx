          ...
          info && info.map((inf, idx) => (<>
            <SwiperSlide key={idx}>
              <div className='w-full relative'>
                ...
                <div className='absolute z-30 right-12 top-32 md:right-16 md:top-[16rem] flex flex-col lg:justify-center justify-evenly items-start p-3 lg:p-6 rounded-3xl w-[80%] lg:w-[40%] gap-2 md:gap-6 text-start backdrop-blur-lg'>
